...
import net.mikaelzero.mojito.view.sketch.core.cache.recycle.AttributeStrategy;
import net.mikaelzero.mojito.view.sketch.core.cache.recycle.LruPoolStrategy;
import net.mikaelzero.mojito.view.sketch.core.cache.recycle.SizeConfigStrategy;
