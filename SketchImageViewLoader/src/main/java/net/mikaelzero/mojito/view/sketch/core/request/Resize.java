...
public class Resize implements Key {
    ...
    static class ByViewFixedSizeResize extends Resize {
        static Resize.ByViewFixedSizeResize INSTANCE = new Resize.ByViewFixedSizeResize();
        static Resize.ByViewFixedSizeResize INSTANCE_EXACTLY_SAME = new Resize.ByViewFixedSizeResize(Mode.EXACTLY_SAME);
